 ...
 * @date: 2020/9/6 9:45
 */
public class TotalDonationMoneyThread extends TotalInfoDetailAbstractTread {
    public TotalDonationMoneyThread(
    ...
    @Override
    public void run() {
        totalInfoDetail.setTotalDonationMoney(adminInfoMapper.getTotalDonationMoney());
        countDownLatchDown();
